...
begin
  ...
  for S in ReservedWordsAndDirectives do
    ReservedWords.Add(S);
  if Screen.Fonts.IndexOf('Fira Mono') >= 0 then MonoSpaceFont := 'Fira Mono'
  else if Screen.Fonts.IndexOf('Roboto Mono') >= 0 then MonoSpaceFont := 'Roboto Mono'
  else if Screen.Fonts.IndexOf('Lucida Console') >= 0 then MonoSpaceFont := 'Lucida Console'
  else if Screen.Fonts.IndexOf('Consolas') >= 0 then MonoSpaceFont := 'Consolas'
  else MonoSpaceFont := 'Courier New';
end;
...
var
  ...
  begin
    Attr.Name := MonoSpaceFont; // 'Lucida Console';
    Attr.Size := 9;
